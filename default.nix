...
# Build inputs
, zlib, libx11, libxcb, libxrandr, libxcomposite, libxdamage, libxscrnsaver, libxcursor
, libxfixes, libxi, libxtst, libxcb-image, libxcb-render-util, libxshmfence, libxinerama
